  ...
  return (
    <section id="get-started" className="relative w-full py-32 bg-white overflow-hidden scroll-mt-28">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center text-center space-y-12">
        ...
        <div className="max-w-200 space-y-4 md:space-y-6">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-medium tracking-tight text-neutral-900 drop-shadow-sm">
            Stop scanning. <span className="text-neutral-500">Start hiring.</span>
          </h2>
          <p className="text-lg sm:text-xl font-light text-neutral-500 leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="pt-4 sm:pt-8 w-full sm:w-auto">
          <div className="p-1 sm:p-1.5 rounded-[2.5rem] bg-black/5 border border-black/10 backdrop-blur-2xl inline-block w-full sm:w-auto">
             <Button size="lg" className="rounded-[calc(2.5rem-0.25rem)] sm:rounded-[calc(2.5rem-0.375rem)] w-full sm:w-auto px-6 sm:px-10 py-6 sm:py-8 text-base sm:text-lg font-medium bg-neutral-900 text-white hover:bg-black group transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] shadow-[0_0_40px_rgba(0,0,0,0.1)]">
              Create Free Account
              <span className="ml-2 sm:ml-3 flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-white/10 transition-transform duration-500 group-hover:translate-x-1 group-hover:-translate-y-px">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 sm:w-4 sm:h-4">
