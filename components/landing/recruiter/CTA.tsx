...
export function CTA() {
  return (
    <section className="relative w-full py-32 bg-white overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-purple-600/20 rounded-full blur-[150px] pointer-events-none mix-blend-darken" />
