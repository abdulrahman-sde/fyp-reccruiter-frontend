      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col md:flex-row gap-16 lg:gap-24">
        ...
        <div className="w-full md:w-5/12 flex flex-col items-start">
          <div className="sticky top-32 space-y-6">
            ...
            <h2 className="text-4xl md:text-6xl font-medium tracking-tight text-neutral-900 leading-[1.1]">
          ...
          {steps.map((step, i) => (
            <div key={i} className="relative group">
              ...
              <div className="flex gap-8">
                <div className="relative shrink-0 w-12 h-12 rounded-full bg-black/5 border border-black/10 flex items-center justify-center backdrop-blur-md z-10">
                ...
                <div className="pt-2 pb-8">
                  <h3 className="text-2xl font-medium text-neutral-900 mb-4">{step.title}</h3>
